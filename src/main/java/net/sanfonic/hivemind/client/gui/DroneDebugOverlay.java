...
public class DroneDebugOverlay {
  ...
  public static void toggle() {
    ...
    if (client.player != null) {
      client.player.sendMessage(
          Text.literal("Debug Overlay: " + (enabled ? "§aON" : "§cOFF")), true // Action bar
          );
    }
  }
  ...
  private static List<String> buildDebugLines(DroneEntity drone, MinecraftClient client) {
    ...
    if (drone.hasHiveMindOwner()) {
      ...
      boolean isOwnedByPlayer =
          drone.getHiveMindOwnerUuid() != null
              && client.player != null
  ...
  private static void renderTextWithBackground(
      MatrixStack matrices, List<String> lines, TextRenderer textRenderer) {
