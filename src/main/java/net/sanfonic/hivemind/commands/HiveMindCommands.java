...
public class HiveMindCommands {
  ...
  private static boolean linkDroneWithEffects(
      ServerPlayerEntity player, DroneEntity drone, ServerCommandSource source, String method) {
        ...
        source.sendFeedback(
            () ->
                Text.literal("⚠ ")
                    ...
                    .append(
                        Text.literal(hiveCode != null ? hiveCode : "???")
        ...
        source.sendFeedback(
            () ->
                Text.literal("⚠ ")
                    ...
                    .append(
                        Text.literal("This drone belongs to another player!")
  ...
  private static void spawnLinkingParticles(ServerWorld world, Vec3d pos) {
    ...
    for (int i = 0; i < 12; i++) {
      ...
      world.spawnParticles(
          ParticleTypes.END_ROD, x + offsetX, y, z + offsetZ, 1, 0.0, 0.0, 0.0, 0.02);
    }
  }
  ...
  public static void register() {
    CommandRegistrationCallback.EVENT.register(
        ((commandDispatcher, commandRegistryAccess, registrationEnvironment) -> {
              ...
              CommandManager.literal("hivemind_link")
                  ...
                  .executes(
                      context -> {
                        ...
                        List<Entity> allNearbyEntites =
                            world.getOtherEntities(player, Box.of(playerPos, 20, 20, 20));
                        ...
                        if (closestDrone != null) {
                          ...
                          if (linkDroneWithEffects(
                              player,
                              closestDrone,
                              source,
                              "Closest - " + String.format("%.1fm", finalDistance))) {
                            return 1;
                          }
                        }
                          ...
                          source.sendFeedback(
                              () ->
                                  Text.literal("⚠ ")
                                      .formatted(Formatting.YELLOW)
                                      .append(
                                          Text.literal("No unlinked drones found within 20 blocks.")
                                              .formatted(Formatting.GRAY)),
                              false);
                          return 1;
                        }
                        ...
                        source.sendFeedback(
                            () ->
                                Text.literal("✓ ")
                                    ...
                                    .append(
                                        Text.literal(String.valueOf(finalCount))
                  ...
                  .executes(
                      context -> {
                        ...
                        if (player == null) {
                          source.sendFeedback(
                              () ->
                                  Text.literal("§cThis command can only be executed by a player!"),
                              false);
                          return 1;
                        }
                        ...
                        Box searchBox =
                            Box.of(playerPos, 2000, 256, 2000); // 2000x256x2000 search area
                        ...
                        if (connectedDrones.isEmpty()) {
                          source.sendFeedback(
                              () -> Text.literal("§eYou have no connected Drones."), false);
                        } else {
                          source.sendFeedback(
                              () -> Text.literal("§a=== Your Connected Drones ==="), false);
                          source.sendFeedback(
                              () ->
                                  Text.literal(
                                      "§7Found " + connectedDrones.size() + " connected drone(s):"),
                              false);
                          ...
                          for (int i = 0; i < connectedDrones.size(); i++) {
                            ...
                            String healthStr =
                                String.format("%.1f/%.1f", drone.getHealth(), drone.getMaxHealth());
          ...
          var hiveCommand =
              CommandManager.literal("hive").requires(source -> source.hasPermissionLevel(0));
