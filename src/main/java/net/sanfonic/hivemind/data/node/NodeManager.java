...
public final class NodeManager {
    ...
    public static void registerNode(Node node) { REGISTRY.put(node.getId(), node); }
    public static Node getNode(String id) { return REGISTRY.get(id); }
    public static Map<String, Node> getAllNodes() { return Collections.unmodifiableMap(REGISTRY); }
    ...
    public static boolean claimForPlayer(MinecraftServer server, ServerPlayerEntity player, String nodeId) {
