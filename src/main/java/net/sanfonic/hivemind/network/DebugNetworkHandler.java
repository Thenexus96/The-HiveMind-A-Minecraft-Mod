...
public class DebugNetworkHandler {
  ...
  public static void register() {
    ServerPlayNetworking.registerGlobalReceiver(
        DebugNetworkConstants.DEBUG_SPAWN_PACKET,
    ...
    ServerPlayNetworking.registerGlobalReceiver(
        DebugNetworkConstants.DEBUG_KILL_NEARBY_PACKET,
        (server, player, handler, buf, responseSender) -> {
    ...
    ServerPlayNetworking.registerGlobalReceiver(
        DebugNetworkConstants.DEBUG_TELEPORT_PACKET,
        (server, player, handler, buf, responseSender) ->
  ...
  private static void handleDebugTeleport(ServerPlayerEntity player) {
    ...
    // Find a safe Y at the target X/Z by scanning down from the top of the world to the first
    // non-air block
